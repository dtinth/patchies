...
- Behind the scenes, this uses [Trystero](https://github.com/dmotz/trystero) (torrent strategy) and [WebRTC](https://developer.mozilla.org/en-US/docs/Web/API/WebRTC_API) for peer-to-peer mesh connections.
